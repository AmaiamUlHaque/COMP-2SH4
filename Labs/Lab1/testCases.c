...
//=================Question 4================================ 
    ...
    void TestQ4_Custom() {
        ...
        int targetArray[29] = {'u','r','k','l','x','o','q','j','d','v','g','p','e','h','m','y','s','b','z','f','w','i','c','t','n',' ','?','5','a'};
		int inputSize = 29;
        int expectedArray[29] = {' ','5','?','a','b','c','d','e','f','g','h','i','j','k','l','m','n','o','p','q','r','s','t','u','v','w','x','y','z'};
        int expectedPass = 27;
        int actualPass = Q4_Bubble(targetArray, inputSize);        
        int result = assert_equal_int(expectedPass, actualPass);
