...
bool runAllTests(int argc, char const *argv[]) {
	...
	cout << "[LINEAR PROBING HASH TABLE TESTER ENDED]\n\n" << endl;
	...
	cout << "[QUADRATIC PROBING HASH TABLE TESTER ENDED]\n\n" << endl << endl;
	...
	cout << "[DOUBLE HASHING HASH TABLE TESTER ENDED]\n\n" << endl;
